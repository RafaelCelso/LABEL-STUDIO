...
export const AuthComponent = ({
  ...
  const handleFinalSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const nameFromEmail = email.split("@")[0]?.trim() || "Usuário";
    ...
    <div className="bg-background min-h-screen w-screen flex flex-col">
      ...
      >
        <div className="absolute inset-0 z-0">
          <AuthGradientBackground idPrefix="signup" />
        </div>
        <fieldset
                    ...
                    <BlurFade delay={0.25 * 6} className="w-full text-center mt-2">
                      <p className="text-sm text-muted-foreground">
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            onSignIn ? onSignIn() : router.push("/auth/sign-in")
                          }
